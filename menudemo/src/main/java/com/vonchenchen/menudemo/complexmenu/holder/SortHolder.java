...
public class SortHolder extends BaseWidgetHolder<List<String>>{
    ...
    /** 综合排序 */
    public static final String SORT_BY_NORULE = "1";
    /** 评价最高 */
    ...
    public View initView() {
        ...
        mLowPriceView = view.findViewById(R.id.re_sort3);
        mHighPriceView = view.findViewById(R.id.re_sort4);
        mDistanceView = view.findViewById(R.id.re_sort5);
        ...
        mLowPriceImage = (ImageView) view.findViewById(R.id.img_sort3);
        mHighPriceImage = (ImageView) view.findViewById(R.id.img_sort4);
        mDistanceImage = (ImageView) view.findViewById(R.id.img_sort5);
